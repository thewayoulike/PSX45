...
export const RealizedTable: React.FC<RealizedTableProps> = (props) => {
  if (props.portfolioType === 'MUTUAL_FUND') {
    return <FundRealizedView trades={props.trades} displayNames={props.displayNames} unrealizedPL={props.unrealizedPL ?? 0} />;
  }
  return <PsxRealizedTable {...props} />;
};
