      ...
      <div className="p-6 border-b border-slate-200/60 dark:border-slate-700/60 flex flex-col xl:flex-row justify-between gap-5 bg-slate-50/50 dark:bg-slate-800/20">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex items-center gap-2"> 
                <span className="text-[10px] bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md border border-blue-200/60 dark:border-blue-500/20 whitespace-nowrap font-bold uppercase tracking-widest shadow-sm">Sold Positions</span> 
                <div className="text-xs font-bold text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800 px-2.5 py-1 rounded-md border border-slate-200/60 dark:border-slate-700/60 shadow-sm tabular-nums"> {filteredAndSortedTrades.length} / {trades.length} </div> 
            </div>
        </div>
