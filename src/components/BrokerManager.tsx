...
import { X, Plus, Pencil, Trash2, Save, AlertCircle, Settings2, CalendarClock, ListPlus, ArrowDown } from 'lucide-react';
                      ...
                      {commType === 'SLAB' ? (
                          <div className="space-y-3">
                              ...
                              <div className="bg-indigo-50/60 p-3 rounded-lg border border-indigo-100">
                                  ...
                                  <div className="flex items-center gap-2">
                                      <input 
                                          ...
                                          className="w-full p-2 rounded border border-indigo-200 text-xs font-bold text-indigo-700 focus:border-indigo-500 outline-none bg-white"
                              ...
                              <div className="relative">
                                  <div className="absolute left-1/2 -top-3 transform -translate-x-1/2 bg-slate-50 text-slate-300">
                                      <ArrowDown size={12} />
                                  </div>
                              </div>
                      ...
                      <td className="px-4 py-3">
                         ...
                         {b.commissionType === 'SLAB' && b.slabs ? (
                             <div className="flex flex-col gap-0.5 mt-1">
                                 ...
                                 {b.rate1 > 0 && (
                                     <div className="text-[9px] text-indigo-600 font-bold bg-indigo-50 px-1 rounded w-fit mb-0.5">
                                         Min: {b.rate1}%
                                     </div>
                                 )}
