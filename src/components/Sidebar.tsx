  ...
  return (
    <>
      ...
      `}>
        ...
        {/* Header / Logo Area - RESTORED TO CENTERED VERTICAL LAYOUT */}
        <div className="relative flex flex-col items-center justify-center pt-8 pb-6 border-b border-slate-100 dark:border-slate-800/60 shrink-0 min-h-[130px]">
          
          {/* Your Custom Logo */}
          <div className="flex-shrink-0 origin-center scale-110">
             <Logo />
          </div>

          {/* Mobile Close Button (Absolute positioned so it doesn't break logo centering) */}
          <button 
            onClick={onClose}
