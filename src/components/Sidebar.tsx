...
import {
  ...
  Compass, Wrench, BarChart3, LayoutGrid, UsersRound, FlaskConical, Bot
} from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const groupOfView: Record<string, string> = {
    ...
    SIGNALS: 'Tools', WATCHLIST: 'Tools', ALERTS: 'Tools', AI_AGENT: 'Tools', SIMULATOR: 'Tools', CALCULATOR: 'Tools', CHARTS: 'Tools', BACKTEST: 'Tools', DAILY_SCAN: 'Tools',
  ...
  const groups: NavGroup[] = useMemo(() => {
    ...
    if (!isFundPortfolio) {
      toolItems.push(
        ...
        { id: 'DAILY_SCAN', label: 'Daily Scan Bot', icon: <Bot size={22} /> },
