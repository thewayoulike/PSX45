...
import { X, Plus, ChevronDown, RefreshCw, Settings, ArrowLeft, Trash2, Pencil, Loader2 } from 'lucide-react';
        ...
        {showBrokerManager ? (
            <div className="p-6 flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="space-y-2">
                    ...
                    {brokers.length === 0 && (
                        <p className="text-center text-slate-400 text-sm py-4">No brokers added yet.</p>
                    )}
                </div>
            </div>
        ) : (
