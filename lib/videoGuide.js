...
export const videoGuide = {
  ...
  description: 'Learn PSX Tracker in six minutes: create a portfolio, configure your broker, add trades, read holdings, sync Google Drive, and scan broker documents or emails with Gemini.',
  video: '/media/tutorial/psx-tracker-guide-v1.mp4',
  poster: '/media/tutorial/poster-v1.jpg',
...
export function videoGuideHead() {
  ...
  return `<link rel="stylesheet" href="/video-guide.css"><script src="/video-guide.js" defer></script><script type="application/ld+json">${JSON.stringify(schema).replace(/</g, '\\u003c')}</script>`;
}
  ...
  return `<div class="guide-meta"><span>5 min 36 sec</span><span>English voice &amp; captions</span><span>Demo account</span></div>
    <div class="watch-layout">
      <section class="watch-panel" id="watch" aria-label="Video walkthrough">
        ...
        <div class="video-links"><a href="${videoGuide.video}" download>Download video <span>(11 MB)</span></a><a href="/media/tutorial/transcript-v1.txt">Read the full transcript</a></div>
    ...
    <div class="guide-next"><div><h2>Ready to try it?</h2><p>Open PSX Tracker and follow along at your own pace.</p></div><div class="actions"><a class="button" href="/holdings">Open PSX Tracker</a><a class="button secondary" href="/guides">Browse written guides</a></div></div>
