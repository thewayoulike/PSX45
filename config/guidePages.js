...
export const guidePages = {
  'fifo-cost-basis-psx': {
    ...
    related: ['cgt-basics-pakistan-stocks', 'importing-broker-trades'],
  },
  'cgt-basics-pakistan-stocks': {
    ...
    related: ['fifo-cost-basis-psx', 'importing-broker-trades'],
  },
  'mutual-fund-nav-tracking': {
    ...
    related: ['free-vs-paid-trial', 'google-drive-backup-restore'],
  },
  ...
  'psx-charts-in-app': {
    ...
    related: ['fifo-cost-basis-psx', 'free-vs-paid-trial'],
  },
  'free-vs-paid-trial': {
  ...
  'importing-broker-trades': {
    ...
    related: ['fifo-cost-basis-psx', 'google-drive-backup-restore'],
  },
};
...
export const guideHub = {
  ...
  description: 'Practical guides on FIFO cost basis, CGT basics, mutual fund NAV, Drive backup, charts, plans and trade imports for PSX Tracker.',
